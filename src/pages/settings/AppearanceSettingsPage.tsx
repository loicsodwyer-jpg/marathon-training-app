  ...
  return (
    <div className="space-y-4">
      <PageCard className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 rounded-[20px] border border-stone-100 bg-stone-50 p-2 dark:border-white/10 dark:bg-slate-950/50">
          <ThemeButton
  ...
  return (
    <button
      ...
      className={`flex h-11 items-center justify-center gap-2 rounded-[16px] text-sm font-semibold transition ${
        isActive
          ? 'bg-white text-stone-950 shadow-sm dark:bg-cyan-300 dark:text-slate-950'
