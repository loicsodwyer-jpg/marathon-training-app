        ...
        return (
          <button
            ...
            className={`w-full rounded-[18px] border p-3 text-left transition ${
              isActive
                ...
                : 'border-stone-100 bg-stone-50 text-stone-700 hover:bg-stone-100 dark:border-white/10 dark:bg-white/[0.05] dark:text-slate-300 dark:hover:bg-white/[0.08]'
            }`}
            key={level}
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="shrink-0 rounded-full border border-stone-200 bg-white px-2.5 py-1 text-xs font-semibold text-stone-700 dark:border-white/10 dark:bg-slate-950/60 dark:text-slate-200">
