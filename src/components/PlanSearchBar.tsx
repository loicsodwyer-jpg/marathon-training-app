    ...
    <div className="space-y-3 rounded-[24px] border border-stone-200 bg-white p-4 shadow-[0_18px_45px_rgba(49,55,70,0.07)] dark:border-white/10 dark:bg-slate-900/85 dark:shadow-[0_22px_70px_rgba(0,0,0,0.35)]">
      <label className="block">
        ...
        <div className="relative">
          <Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-stone-400 dark:text-slate-500" aria-hidden="true" />
          <input
            className="h-12 w-full rounded-[18px] border border-stone-200 bg-stone-50 px-10 text-sm font-semibold text-stone-900 outline-none transition placeholder:text-stone-400 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:border-white/10 dark:bg-slate-950/70 dark:text-white dark:placeholder:text-slate-600 dark:focus:border-cyan-300 dark:focus:ring-cyan-300/10"
          ...
          {searchTerm ? (
            <button
              ...
              className="absolute right-2 top-1/2 grid h-8 w-8 -translate-y-1/2 place-items-center rounded-full text-stone-500 transition hover:bg-stone-200 dark:text-slate-400 dark:hover:bg-white/[0.08]"
