...
function CalendarExportPreview({ events }: CalendarExportPreviewProps) {
  ...
  return (
    <section className="space-y-3 rounded-[22px] border border-stone-100 bg-stone-50 p-3 dark:border-white/10 dark:bg-slate-950/35">
      ...
      {previewEvents.length ? (
        <div className="space-y-2">
          ...
          {events.length > previewEvents.length ? (
            <p className="px-1 text-sm text-stone-500 dark:text-slate-400">
