        ...
        <div className="max-h-[calc(100dvh-96px)] overflow-y-auto p-4 pb-[calc(24px+env(safe-area-inset-bottom))]">
          {onStartSession ? (
            <button
              ...
              className="mb-4 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-[20px] bg-purple-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-purple-500 dark:bg-purple-300 dark:text-slate-950 dark:hover:bg-purple-200"
