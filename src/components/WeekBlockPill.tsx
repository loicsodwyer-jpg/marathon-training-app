...
const classNameByCategory: Record<ScheduleBlockCategory, string> = {
  wake: 'border-slate-200 bg-slate-100 text-slate-700 dark:border-white/10 dark:bg-white/[0.07] dark:text-neutral-200',
  commute:
    'border-slate-200 bg-slate-100 text-slate-700 dark:border-white/10 dark:bg-white/[0.07] dark:text-neutral-200',
  work: 'border-slate-200 bg-slate-100 text-slate-700 dark:border-white/10 dark:bg-white/[0.07] dark:text-neutral-200',
